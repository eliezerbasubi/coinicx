...
const AdaptivePagination = <TData,>({ table }: Props<TData>) => {
  return (
    <div className="flex items-center justify-end space-x-2 sm:space-x-6 lg:space-x-8 text-neutral-gray-100">
...
export default AdaptivePagination;
